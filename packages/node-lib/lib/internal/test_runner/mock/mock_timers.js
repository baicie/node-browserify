...
class MockTimers {
  ...
  #restoreSetImmediate() {
    ObjectDefineProperty(globalThis, 'setImmediate', this.#realSetImmediate)
    ObjectDefineProperty(globalThis, 'clearImmediate', this.#realClearImmediate)
    ObjectDefineProperty(
      nodeTimers,
      'setImmediate',
  ...
  #restoreOriginalSetInterval() {
    ObjectDefineProperty(globalThis, 'setInterval', this.#realSetInterval)
    ObjectDefineProperty(globalThis, 'clearInterval', this.#realClearInterval)
    ObjectDefineProperty(nodeTimers, 'setInterval', this.#realTimersSetInterval)
    ObjectDefineProperty(
      nodeTimers,
      'clearInterval',
  ...
  #restoreOriginalSetTimeout() {
    ObjectDefineProperty(globalThis, 'setTimeout', this.#realSetTimeout)
    ObjectDefineProperty(globalThis, 'clearTimeout', this.#realClearTimeout)
    ObjectDefineProperty(nodeTimers, 'setTimeout', this.#realTimersSetTimeout)
    ObjectDefineProperty(
      nodeTimers,
      'clearTimeout',
  ...
  #createDate() {
    ...
    const { prototype, ...dateProps } = ObjectGetOwnPropertyDescriptors(
    ...
    MockDate.toString = function toString() {
      return FunctionPrototypeToString(
  ...
  #toggleEnableTimers(activate) {
    const options = {
      ...
      toFake: {
        ...
        Date: () => {
          this.#nativeDateDescriptor = ObjectGetOwnPropertyDescriptor(
            globalThis,
            'Date',
          )
